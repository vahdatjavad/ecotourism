...
We are investigating occurrence data of [**Penguins**](https://en.wikipedia.org/wiki/Penguin) in Australia from the **Atlas of Living Australia**, and make a map showing the spatial locations of sightings for 2024.
...
the length of the records is `r nrow(penguins_2024)`
...
We have organized the penguin occurrence and weather station data into the following structured datasets, stored in the `data/` directory:

-   `penguins_2024.rda`  
    Contains penguin occurrence records across all states in Australia.

-   `penguins_2024_ws.rda`  
...
-   `penguins_top_weather.rda`  
    Focuses on weather data from the top 3 most frequently recorded stations associated with penguin occurrences.

...
ggplot() +
  ...
  labs(
    title = "Distribution of thorny_devil_2024_ws Sightings in Australia (2024)",
    x = "Longitude",
    y = "Latitude",
    color = "State"
  )
...
ggplot() +
  ...
  labs(
    title = "Monthly Distribution of thorny_devil_2024_ws Sightings in Australia (2024)",
    x = "Longitude",
    y = "Latitude",
    color = "State"
  )

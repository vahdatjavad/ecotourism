...
orchids_station_counts <- orchids_ws |> 
...
ggplot() +
 ...
 geom_point(data = orchids_ws, aes(x = obs_lon, y = obs_lat, color = state), alpha = 0.6, size = 1.5) +
  geom_point(data = orchids_station_counts[1:3,], aes(x = stn_lon, y = stn_lat), shape = 2, alpha = 1, size = 2) +
...
ggplot() +
  geom_sf(data = aus_map, fill = "gray95", color = "gray50") +
 geom_point(data = gouldian_finch_ws, aes(x = obs_lon, y = obs_lat, color = state), alpha = 0.6, size = 1.5) +
...
ggplot() +
  geom_sf(data = aus_map, fill = "gray95", color = "gray50") +
 geom_point(data = glowworms_ws, aes(x = obs_lon, y = obs_lat, color = state), alpha = 0.6, size = 1.5) +
  geom_point(data = station_counts[1:3,], aes(x = stn_lon, y = stn_lat), shape = 2, alpha = 1, size = 2) +
  coord_sf(xlim = c(110, 155), ylim = c(-45, -10)) +
  theme_minimal()
```
...
ggplot() +
  geom_sf(data = aus_map, fill = "gray95", color = "gray50") +
 geom_point(data = manta_rays_ws, aes(x = obs_lon, y = obs_lat, color = state), alpha = 0.6, size = 1.5) +
  geom_point(data = station_counts[1:3,], aes(x = stn_lon, y = stn_lat), shape = 2, alpha = 1, size = 2) +
  coord_sf(xlim = c(110, 155), ylim = c(-45, -10)) +
  theme_minimal()
```
